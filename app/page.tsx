                    ...
                    <div className='relative'>
                        <section>
                            <div className="max-w-screen-2xl mx-auto px-4 my-20 gap-40 text-gray-600 overflow-hidden md:px-8 md:flex">
                                ...
                                <p>
                                    Welcome to CourseCrafter – Notre Dame's game-changer in academic planning! Tailored for computer science majors, it blends minors and concentrations into a dynamic, four-year scheduling masterpiece. Real-time updates, multiple saved schedules, and diverse course recommendations make CourseCrafter your ultimate tool for an exhilarating academic journey at Notre Dame. Get ready to craft your future, today!
                                </p>
                    ...
                    <div className="items-center gap-x-48 sm:px-4 md:px-0 lg:flex">
                        ...
                        <div className="max-w-xl px-4 space-y-3 mt-6 sm:px-0 md:mt-0 lg:max-w-2xl">
                            ...
                            <p className="mt-3 text-gray-600">
                                Dive into CourseCrafter and start crafting your ideal Notre Dame journey! Our tool makes it fun and easy to map out your four-year schedule, with the added perk of personalized course recommendations. Explore Notre Dame's wide range of classes and find the perfect fit for your interests and goals. With CourseCrafter, planning your academic future is not just simple – it's exciting. Start your journey today and see where CourseCrafter can take you!
                            </p>
