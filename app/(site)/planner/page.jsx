        ...
        <div>
            ...
            {columns ? (
                ...
                <div className="my-6 flex justify-center w-full">
                    <div className="justify flex-col">
                        ...
                        {isLoading ? (
                            <div role="status" className="flex justify-center w-full my-24">
            ...
            <div>
                {!schedules ? (
                    ...
                    <div className={`my-4 ${!schedules ? 'hidden' : ''}`}>
                        <div className="flex justify-center items-center flex-wrap gap-4">
                            <button
                                onClick={() => setShowCreateModal(true)}
                                className="px-4 sm:px-6 md:px-10 py-2 md:py-4 text-sm md:text-lg duration-200 font-semibold bg-green-100 rounded-full hover:bg-green-200 active:bg-green-300 focus:outline-none focus:ring focus:ring-green-300"
                            >
                                Create Schedule
                            </button>
                            <button
                                ...
                                className="px-4 sm:px-6 md:px-10 py-2 md:py-4 text-sm md:text-lg duration-200 font-semibold bg-blue-100 rounded-full hover:bg-blue-200 active:bg-blue-300 focus:outline-none focus:ring focus:ring-blue-300 disabled:bg-gray-300 disabled:text-gray-600"
                            >
                                Load Schedule
                            </button>
                            <button
                                ...
                                disabled={!columns}
                                className="px-4 sm:px-6 md:px-10 py-2 md:py-4 text-sm md:text-lg duration-200 font-semibold bg-yellow-100 rounded-full hover:bg-yellow-200 active:bg-yellow-300 focus:outline-none focus:ring focus:ring-yellow-300 disabled:bg-gray-300 disabled:text-gray-600"
                            >
                                Save Schedule
                            </button>
                            <button
                                ...
                                disabled={!columns}
                                className="px-4 sm:px-6 md:px-10 py-2 md:py-4 text-sm md:text-lg duration-200 font-semibold bg-red-100 rounded-full hover:bg-red-200 active:bg-red-300 focus:outline-none focus:ring focus:ring-red-300 disabled:bg-gray-300 disabled:text-gray-600"
                            >
                                Delete Schedule
                            </button>
                        </div>
